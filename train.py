...
parser.add_argument('--save_dir', type=str, default='./snapshots3/default')
...
parser.add_argument('--save_model_interval', type=float, default=50000)
parser.add_argument('--vis_interval', type=float, default=5000)
