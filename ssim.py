...
img1 = np.array(scipy.misc.imread('/team_stor1/huayu/pc-3/A/1.png', mode='RGB').astype('float32'))
img2 = np.array(scipy.misc.imread('/team_stor1/huayu/pc-3/B/1.png', mode='RGB').astype('float32'))
